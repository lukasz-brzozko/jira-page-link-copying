...
(function () {
  ...
  var toggleIconsVisibility = function toggleIconsVisibility(button) {
    button.classList.toggle("active");
    button.querySelectorAll(".copy-icon").forEach(function (icon) {
      return icon.classList.toggle("invisible");
    });
  };
  var copyPageLinkIntoClipboard = /*#__PURE__*/function () {
    ...
    return function copyPageLinkIntoClipboard(_x) {
  ...
  var generateBtn = function generateBtn() {
    ...
    btnEl.addEventListener("click", function (e) {
      return copyPageLinkIntoClipboard(e);
    });
